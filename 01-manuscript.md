...
That is, the optimal variational density is the continuous Bernoulli with parameter $\theta_i$, recovering the local posterior family already derived from the MaxEnt construction. The expected value under this optimal posterior gives the inference rule:
