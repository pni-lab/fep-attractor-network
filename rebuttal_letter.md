...
We sincerely thank you for the constructive and insightful feedback on our manuscript, *Self-orthogonalizing attractor neural networks emerging from the free energy principle*. We are delighted that you consider our manuscript of potential interest for the readership of Neurocomputing. We are encouraged by the reviewers’ overall positive evaluation of the study. We carefully revised the manuscript and appendix to improve biological grounding, accessibility, empirical context, and discussion of scalability and limitations. We also prepared additional simulations to address comments on scaling and computational efficiency with more realistic data.

Below, we present our point-by-point responses to each of the reviewers’ comments (reviewer comments in bold, author replies in black, quoted manuscript additions in italics). We hope that the revisions and our accompanying responses will be sufficient to make our manuscript suitable for publication in Neurocomputing. We would be also glad to respond to any further questions and comments that you and the reviewers may have. 
